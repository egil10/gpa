/**
 * Discover and fetch ALL DMMH courses
 */
...
async function discoverDMMHCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     DMMH All Courses Discovery & Export (Batched)          ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8224';
  const institutionName = 'DMMH';
  ...
  const outputFile = path.join(dataDir, 'dmmh-all-courses.json');
...
discoverDMMHCourses().catch(console.error);
