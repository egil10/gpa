/**
 * Discover and fetch ALL MF courses
 */
...
async function discoverMFCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     MF All Courses Discovery & Export (Batched)            ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8221';
  const institutionName = 'MF';
  ...
  const outputFile = path.join(dataDir, 'mf-all-courses.json');
...
discoverMFCourses().catch(console.error);
