/**
 * Discover and fetch ALL INN courses
 * Uses the same structure as UiA/NMBU/Nord/OsloMet/UiO/UiB/NTNU discovery scripts
 */
...
async function discoverINNCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     INN All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '1177';
  const institutionName = 'INN';
  ...
  const outputFile = path.join(dataDir, 'inn-all-courses.json');
...
// Run discovery
discoverINNCourses().catch(console.error);
