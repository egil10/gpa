/**
 * Discover and fetch ALL FIH courses
 */
...
async function discoverFIHCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     FIH All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8234';
  const institutionName = 'FIH';
  ...
  const outputFile = path.join(dataDir, 'fih-all-courses.json');
...
discoverFIHCourses().catch(console.error);
