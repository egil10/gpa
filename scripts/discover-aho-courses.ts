/**
 * Discover and fetch ALL AHO courses
 */
...
async function discoverAHOCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     AHO All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '1220';
  const institutionName = 'AHO';
  ...
  const outputFile = path.join(dataDir, 'aho-all-courses.json');
...
discoverAHOCourses().catch(console.error);
