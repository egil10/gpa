/**
 * Discover and fetch ALL VID courses
 */
...
async function discoverVIDCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     VID All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8208';
  const institutionName = 'VID';
  ...
  const outputFile = path.join(dataDir, 'vid-all-courses.json');
...
discoverVIDCourses().catch(console.error);
