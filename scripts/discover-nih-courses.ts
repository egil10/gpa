/**
 * Discover and fetch ALL NIH courses
 */
...
async function discoverNIHCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     NIH All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '1260';
  const institutionName = 'NIH';
  ...
  const outputFile = path.join(dataDir, 'nih-all-courses.json');
...
discoverNIHCourses().catch(console.error);
