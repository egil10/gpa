/**
 * Discover and fetch ALL BI courses
 * Uses the same structure as NHH/UiO/UiB/NTNU discovery scripts
 */
...
async function discoverBICourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     BI All Courses Discovery & Export (Batched)            ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8241';
  const institutionName = 'BI';
  ...
  const outputFile = path.join(dataDir, 'bi-all-courses.json');
...
// Run discovery
discoverBICourses().catch(console.error);
