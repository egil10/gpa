/**
 * Discover and fetch ALL SH courses
 */
...
async function discoverSHCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     SH All Courses Discovery & Export (Batched)            ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '0217';
  const institutionName = 'SH';
  ...
  const outputFile = path.join(dataDir, 'sh-all-courses.json');
...
discoverSHCourses().catch(console.error);
