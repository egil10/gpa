/**
 * Discover and fetch ALL KHIO courses
 */
...
async function discoverKHIOCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     KHIO All Courses Discovery & Export (Batched)          ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '6220';
  const institutionName = 'KHIO';
  ...
  const outputFile = path.join(dataDir, 'khio-all-courses.json');
...
discoverKHIOCourses().catch(console.error);
