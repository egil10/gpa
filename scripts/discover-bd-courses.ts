/**
 * Discover and fetch ALL BD courses
 */
...
async function discoverBDCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     BD All Courses Discovery & Export (Batched)            ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8227';
  const institutionName = 'BD';
  ...
  const outputFile = path.join(dataDir, 'bd-all-courses.json');
...
discoverBDCourses().catch(console.error);
