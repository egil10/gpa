/**
 * Discover and fetch ALL HGUt courses
 */
...
async function discoverHGUtCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     HGUt All Courses Discovery & Export (Batched)          ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8247';
  const institutionName = 'HGUt';
  ...
  const outputFile = path.join(dataDir, 'hgut-all-courses.json');
...
discoverHGUtCourses().catch(console.error);
