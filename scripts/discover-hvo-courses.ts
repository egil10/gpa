/**
 * Discover and fetch ALL HVO courses
 */
...
async function discoverHVOCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     HVO All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '0236';
  const institutionName = 'HVO';
  ...
  const outputFile = path.join(dataDir, 'hvo-all-courses.json');
...
discoverHVOCourses().catch(console.error);
