/**
 * Discover and fetch ALL HFDK courses
 */
...
async function discoverHFDKCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     HFDK All Courses Discovery & Export (Batched)          ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8254';
  const institutionName = 'HFDK';
  ...
  const outputFile = path.join(dataDir, 'hfdk-all-courses.json');
