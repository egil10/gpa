/**
 * Discover and fetch ALL Steiner courses
 */
...
async function discoverSteinerCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     Steiner All Courses Discovery & Export (Batched)       ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8225';
  const institutionName = 'Steiner';
  ...
  const outputFile = path.join(dataDir, 'steiner-all-courses.json');
...
discoverSteinerCourses().catch(console.error);
