/**
 * Discover and fetch ALL AHS courses
 */
...
async function discoverAHSCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     AHS All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '8232';
  const institutionName = 'AHS';
  ...
  const outputFile = path.join(dataDir, 'ahs-all-courses.json');
...
discoverAHSCourses().catch(console.error);
