/**
 * Discover and fetch ALL HVL courses
 */
...
async function discoverHVLCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     HVL All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '0238';
  const institutionName = 'HVL';
  ...
  const outputFile = path.join(dataDir, 'hvl-all-courses.json');
...
discoverHVLCourses().catch(console.error);
