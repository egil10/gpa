/**
 * Discover and fetch ALL UiT courses
 * Uses the same structure as USN/UiS/INN/UiA/NMBU/Nord/OsloMet/UiO/UiB/NTNU discovery scripts
 */
...
async function discoverUiTCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     UiT All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '1130';
  const institutionName = 'UiT';
  ...
  const outputFile = path.join(dataDir, 'uit-all-courses.json');
...
// Run discovery
discoverUiTCourses().catch(console.error);
