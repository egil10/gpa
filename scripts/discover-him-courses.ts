/**
 * Discover and fetch ALL HiM courses
 */
...
async function discoverHiMCourses() {
  console.log(`
╔════════════════════════════════════════════════════════════╗
║     HiM All Courses Discovery & Export (Batched)           ║
╚════════════════════════════════════════════════════════════╝
  `);

  const institutionCode = '0232';
  const institutionName = 'HiM';
  ...
  const outputFile = path.join(dataDir, 'him-all-courses.json');
...
discoverHiMCourses().catch(console.error);
